    ...
    <div class="container-fluid p-0">
        <div class="login-page">
            <div class="row align-items-center">
                <div class="col-md-5">
                    <div class="left-log-in">
                        <img src="{{ asset('assets/custom_auth') }}/log-in.jpg" alt="log-in" class="img-fluid">
                    </div>
                </div>
                <div class="col-md-5 offset-md-1">
                    <div class="login-form">
                                    ...
                                    <div class="col-md-6">
                                        <div class="frgt-pwd">
                                            <a href="{{ route('forget.password.get') }}"
                                                class="frgt-pwd-inline text-decoration-none">Forgot
                                                Password?</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="sign-up ">
                            <span>Already have an account ?</span><a href="{{ route('register') }}" class="text-decoration-none sign-up-a">Sign
                                up</a>
                        </div>
                    </div>
                </div>
