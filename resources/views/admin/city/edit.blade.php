    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-xl-12">
                <div class="row">
                    <div class="col-sm-12">
                        <form class="theme-form" id="city_Edit" method="POST" action="{{ route('city.update', $City->city_id) }}"
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="city_name" class="form-control" name="city_name"
                                                placeholder="City Name" value="{{ $City->city_name }}" required />
                                            @error('city_name')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                ...
                $("#city_Edit").validate({
                    rules: {
                        city_name: {
                            ...
                            remote: {
                                type: 'get',
                                url: '{{ route('check_city_exists_in_update') }}',
                                data: {
                                    'state_id': function() {
                                        return $("#state_id").val();
                                    },
